...
bcfile = open('optimized_javier.bc','w')
bcfile.write('BC1.1\n')
...
layer = int((math.log(16))/(math.log(2)))
#print layer
count = 16
...
current_P = 'P4_0 := NOT(NOT(AND(P3_0,P3_1)));\n'	#.format(each#_box2, each_box2*2, each_box2*2+1)
current_G = 'G4_0 := NOT(AND(NOT(G3_1),NOT(AND(G3_0,P3_1))));\n'	#.format(each_box2, each_box2*2, each_box2*2+1)
nextC = 'C_optimized8 := NOT(AND(NOT(G4_0), NOT(AND(P4_0,OP0))));\n'		#.format(each_box2*2, each_box2*2+1)
bcfile.write(current_P + current_G + nextC)
bcfile.write('\n\n\n')
